...
import com.blueegg.records.ClickEventSerializationSchema;
...
import static com.blueegg.ClickEventCount.WINDOW_SIZE;
...
public class ClickEventGenerator {
	...
	//window size
	public static final long DELAY = ClickEventCount.WINDOW_SIZE.toMilliseconds() / pages.size() / EVENTS_PER_WINDOW;
	...
	static class ClickIterator  {
		...
		private Date nextTimestamp(String page) {
			...
			nextTimestampPerKey.put(page, nextTimestamp + ClickEventCount.WINDOW_SIZE.toMilliseconds() / EVENTS_PER_WINDOW);
